    ...
    return (
        {
            "en": {
                ...
                "bypass": "Bypass State",
                "bypasser": "Bypass Control",
                "heater": "Heater",
                "purifier": "Purifier",
                "purify": "Purifier State",
            },
            "ko": {
                "ctrl_mode": "리모컨모드",
                "ctrl_speed": "리모컨속도",
